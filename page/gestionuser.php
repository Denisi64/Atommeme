            ...
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-dark" data-toggle="modal"
                            data-target="#modalEdit-<?= $user->id ?>"><i class="icofont-pencil"></i></button>
...
<!--    <div class="modal fade" id="modalDelete---><?php //= $meme->id ?><!--" tabindex="-1" role="dialog">-->
...
<!--                </div>-->
<!--                <div class="modal-footer">-->
<!--                    <a href="../partials/deleteimage.php?memeId=--><?php //= $meme->id ?><!--">Oui</a>-->
...
<!--    <!---->-->
<!--    <!-- Edit Modals -->-->
<!--    <div class="modal fade" id="modalEdit---><?php //= $meme->id ?><!--" tabindex="-1" aria-labelledby="editImageModalLabel"-->
<!--         aria-hidden="true">-->
<!--        <div class="modal-dialog">-->
<!--            <div class="modal-content">-->
<!--                <div class="modal-header">-->
...
<!--                                   value="--><?php //= $meme->name ?><!--" required>-->
<!--                        </div>-->
<!--                        <div class="form-group">-->
<!--                            <label for="description">Description :</label>-->
<!--                            <input type="text" class="form-control" id="description" placeholder="Description"-->
<!--                                   name="description" value="--><?php //= $meme->description ?><!--" required>-->
<!--                        </div>-->
<!--                        <div class="form-group">-->
<!--                            <label for="image">Image :-->
<!--                            </label>-->
...
<!--                                   name="image" accept=".jpg, .png, .gif, .jpeg">-->
<!--                        </div>-->
<!--                        <input type="hidden" value="--><?php //= $meme->id ?><!--" name="id">-->
